        ...
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            if (!context.Users.Any())
            {
                var userList = new List<dynamic>
                {
                    ...
                    new { FirstName = "Emma", LastName = "Miller", Email = "EmmaMiller@example.com", Role = UserRole.PendingVerification, VerificationStatus = UserVerificationStatus.NotVerified, DateOfBirth = new DateTime(1986, 6, 30), Street = "Rua Augusta 2385", City = "Sao Paulo", State = "Sao Paulo", PostalCode = "10011", Country = "Brazil", PhoneNumber = "1234567900", PhotoIdUrl = "/peopleImages/woman1/woman1_id.png", FaceIdUrl = "/peopleImages/woman1/woman1_photo.png" , PhotoUrl = "/peopleImages/woman1/woman1_profile.png" }
                };
                int counter = 0;
