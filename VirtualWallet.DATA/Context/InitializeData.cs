    ...
    public static class InitializeData
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            if (!context.Users.Any())
            {
                ...
                {
                    new { FirstName = "John", LastName = "Doe", Email = "JohnDoe@example.com", Role = UserRole.Staff, VerificationStatus = UserVerificationStatus.Verified, DateOfBirth = new DateTime(1985, 5, 15), Street = "4567 Oak Ridge Drive", City = "Denver", State = "CO", PostalCode = "10002", Country = "USA", PhoneNumber = "1123467891", PhotoIdUrl = "staff1-photo-id-url", FaceIdUrl = "staff1-face-id-url" , PhotoUrl = "/peopleImages/man1/man1_profile.png" },
                    new { FirstName = "Jane", LastName = "Smith", Email = "JaneSmith@example.com", Role = UserRole.Staff, VerificationStatus = UserVerificationStatus.Verified, DateOfBirth = new DateTime(1990, 3, 22), Street = "Via della Conciliazione 10", City = "Rome", State = "Lazio", PostalCode = "00193", Country = "Italy", PhoneNumber = "1124567892", PhotoIdUrl = "staff2-photo-id-url", FaceIdUrl = "staff2-face-id-url", PhotoUrl = "peopleImages/man1/man1_profile.png" },
                    new { FirstName = "Tom", LastName = "Johnson", Email = "TomJohnson@example.com", Role = UserRole.Blocked, VerificationStatus = UserVerificationStatus.Verified, DateOfBirth = new DateTime(1978, 7, 12), Street = "42 Hachiko-mae Square", City = "Shibuya", State = "Tokyo", PostalCode = "150-0001", Country = "Japan", PhoneNumber = "1234567893", PhotoIdUrl = "blocked1-photo-id-url", FaceIdUrl = "blocked1-face-id-url", PhotoUrl = "peopleImages/man1/man1_profile.png" },
                    new { FirstName = "Lisa", LastName = "Brown", Email = "LisaBrown@example.com", Role = UserRole.Blocked, VerificationStatus = UserVerificationStatus.Verified, DateOfBirth = new DateTime(1982, 11, 25), Street = "123 Queen Street", City = "Toronto", State = "Ontario", PostalCode = "M5H 2N2", Country = "Canada", PhoneNumber = "1234567894", PhotoIdUrl = "blocked2-photo-id-url", FaceIdUrl = "blocked2-face-id-url", PhotoUrl = "peopleImages/man1/man1_profile.png" },
                    new { FirstName = "Harry", LastName = "Williams", Email = "HarryWilliams@example.com", Role = UserRole.PendingVerification, VerificationStatus = UserVerificationStatus.PendingVerification, DateOfBirth = new DateTime(1991, 9, 9), Street = "12 Rue de Rivoli", City = "Paris", State = "le-de-France", PostalCode = "75004", Country = "France", PhoneNumber = "1234567895", PhotoIdUrl = "pending1-photo-id-url", FaceIdUrl = "pending1-face-id-url", PhotoUrl = "peopleImages/man1/man1_profile.png" },
                    new { FirstName = "Kate", LastName = "Wilson", Email = "KateWilson@example.com", Role = UserRole.PendingVerification, VerificationStatus = UserVerificationStatus.PendingVerification, DateOfBirth = new DateTime(1989, 2, 14), Street = "2380 Sycamore Drive", City = "Columbus", State = "OH", PostalCode = "43215", Country = "USA", PhoneNumber = "1234567896", PhotoIdUrl = "pending2-photo-id-url", FaceIdUrl = "pending2-face-id-url", PhotoUrl = "peopleImages/man1/man1_profile.png" },
                    new { FirstName = "Samuel", LastName = "Garcia", Email = "SamuelGarcia@example.com", Role = UserRole.RegisteredUser, VerificationStatus = UserVerificationStatus.Verified, DateOfBirth = new DateTime(1988, 12, 5), Street = "564 Willowbrook Drive", City = "Seattle", State = "WA", PostalCode = "98104", Country = "USA", PhoneNumber = "1234567897", PhotoIdUrl = "pending3-photo-id-url", FaceIdUrl = "pending3-face-id-url", PhotoUrl = "peopleImages/man1/man1_profile.png" },
                    new { FirstName = "Sophia", LastName = "Martin", Email = "SophiaMartin@example.com", Role = UserRole.RegisteredUser, VerificationStatus = UserVerificationStatus.NotVerified, DateOfBirth = new DateTime(1987, 3, 15), Street = "Konigsallee 5", City = "Dusseldorf", State = "North Rhine-Westphalia", PostalCode = "40212", Country = "Germany", PhoneNumber = "1234567898", PhotoIdUrl = "pending4-photo-id-url", FaceIdUrl = "pending4-face-id-url", PhotoUrl = "peopleImages/man1/man1_profile.png" },
                    new { FirstName = "Michael", LastName = "Davis", Email = "MichaelDavis@example.com", Role = UserRole.PendingVerification, VerificationStatus = UserVerificationStatus.NotVerified, DateOfBirth = new DateTime(1992, 4, 20), Street = "123 Collins Street", City = "Melbourne", State = "Victoria", PostalCode = "3000", Country = "Australia", PhoneNumber = "1234567899", PhotoIdUrl = "registered1-photo-id-url", FaceIdUrl = "registered1-face-id-url", PhotoUrl = "peopleImages/man1/man1_profile.png" },
                    new { FirstName = "Emma", LastName = "Miller", Email = "EmmaMiller@example.com", Role = UserRole.PendingVerification, VerificationStatus = UserVerificationStatus.NotVerified, DateOfBirth = new DateTime(1986, 6, 30), Street = "Rua Augusta 2385", City = "Sao Paulo", State = "Sao Paulo", PostalCode = "10011", Country = "Brazil", PhoneNumber = "1234567900", PhotoIdUrl = "registered2-photo-id-url", FaceIdUrl = "registered2-face-id-url", PhotoUrl = "peopleImages/man1/man1_profile.png" }
                };
                int counter = 0;
